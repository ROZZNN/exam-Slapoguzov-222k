...
import './form.css';
import {validateFullName, validatePhoneNumber, validateFutureDate, validateForm} from './formascript'
      ...
      <form onSubmit={handleSubmit} className="form">
        ...
        <label for="duration">Длительность брони:</label>
          ...
          <div class="checkbox">
            ...
            <label for="agreeCheckbox" class='chekbox'>Я согласен с условиями</label>
          </div>
